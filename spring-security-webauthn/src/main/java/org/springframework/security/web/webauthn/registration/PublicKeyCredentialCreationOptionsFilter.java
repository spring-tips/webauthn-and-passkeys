...
public class PublicKeyCredentialCreationOptionsFilter extends OncePerRequestFilter {
	...
	private RequestMatcher matcher = RequestMatchers.allOf(antMatcher(HttpMethod.POST, "/webauthn/register/options"),
			new AuthenticatedRequestMatcher());
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		PublicKeyCredentialCreationOptions options = this.rpOperations
			.createPublicKeyCredentialCreationOptions(context.getAuthentication());
	...
	private final class AuthenticatedRequestMatcher implements RequestMatcher {
		...
		public boolean matches(HttpServletRequest request) {
			SecurityContext context = PublicKeyCredentialCreationOptionsFilter.this.securityContextHolderStrategy
				.getContext();
