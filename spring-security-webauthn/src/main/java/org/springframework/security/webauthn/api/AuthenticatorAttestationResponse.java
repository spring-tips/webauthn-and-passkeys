...
public class AuthenticatorAttestationResponse extends AuthenticatorResponse {
	...
	/**
	 * FIXME: This is computed from the attestationObject. Needs to be an interface so
	 * that can be computed or injected
	 */
	...
	private AuthenticatorAttestationResponse(Base64Url clientDataJSON, Base64Url attestationObject,
			List<AuthenticatorTransport> transports, Base64Url authenticatorData, Base64Url publicKey,
	 ...
	 * returns the <a
	 * href="https://www.w3.org/TR/webauthn-3/#dom-authenticatorattestationresponse-transports-slot>transports</a>
	...
	/**
	 * The <a href=
	 * "https://www.w3.org/TR/webauthn-3/#dom-authenticatorattestationresponse-getauthenticatordata">authenticatorData</a>
	 * contained within attestationObject. See
	 * <a href="https://www.w3.org/TR/webauthn-3/#sctn-public-key-easy">5.2.1.1 Easily
	 * accessing credential data</a>.
	...
	/**
	 * The <a href=
	 * "https://www.w3.org/TR/webauthn-3/#dom-authenticatorattestationresponse-getpublickey">publicKey</a>
	 * returns the DER <a href=
	 * "https://tools.ietf.org/html/rfc5280#section-4.1.2.7">SubjectPublicKeyInfo</a> of
	 * the new credential, or null if this is not available.
	...
	/**
	 * The <a href=
	 * "https://www.w3.org/TR/webauthn-3/#dom-authenticatorattestationresponse-getpublickeyalgorithm">publicKeyAlgorithm</a>
	...
	public static final class AuthenticatorAttestationResponseBuilder {
		...
		public AuthenticatorAttestationResponse build() {
			return new AuthenticatorAttestationResponse(this.clientDataJSON, this.attestationObject, this.transports,
					this.authenticatorData, this.publicKey, this.publicKeyAlgorithm);
		}
