...
/**
 * FIXME: Consider not using an enum. Spec states The AuthenticatorTransport enumeration
 * is deliberately not referenced, see § 2.1.1 Enumerations as DOMString types. <a href=
