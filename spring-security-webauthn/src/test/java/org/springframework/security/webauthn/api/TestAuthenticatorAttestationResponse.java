	...
	public static AuthenticatorAttestationResponse.AuthenticatorAttestationResponseBuilder createAuthenticatorAttestationResponse() {
		return AuthenticatorAttestationResponse.builder()
			...
			.publicKey(Base64Url.fromBase64(
					"MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAE4Hkrn2kbGmpZTdoDZUNrppo93OqgQV7ONzVvo5GLCFerf6yIQggq2BfZntawxRsBBbWG_FWkYAoU8yPipS-5hg"))
			.authenticatorData(Base64Url.fromBase64(
					"y9GqwTRaMpzVDbXq1dyEAXVOxrou08k22ggRC45MKNhdAAAAALraVWanqkAfvZZFYZpVEg0AEDWRLOHq0Wxw4cOkCemynKqlAQIDJiABIVgg4Hkrn2kbGmpZTdoDZUNrppo93OqgQV7ONzVvo5GLCFciWCCrf6yIQggq2BfZntawxRsBBbWG_FWkYAoU8yPipS-5hg"));
	}
